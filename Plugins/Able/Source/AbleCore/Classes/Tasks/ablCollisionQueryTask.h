...
protected:
	...
	/* The negative shape for our query (if any), any results in here will be filtered from the final results. */
	UPROPERTY(EditAnywhere, Instanced, Category = "Query", meta = (DisplayName = "Negative Query Shape"))
	UAblCollisionShape* m_NegativeQueryShape;
