...
protected:
    ...
    UPROPERTY(EditAnywhere, Category="Animation", meta = (DisplayName = "Animation", AblBindableProperty, AblDefaultBinding = "OnGetAnimationAssetBP", AllowedClasses = "/Script/Engine.AnimMontage,/Script/Engine.AnimSequence"))
